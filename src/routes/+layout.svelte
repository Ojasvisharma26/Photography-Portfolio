...
<svelte:head>
	...
	<meta content="/Ojasvi.jpg" property="og:image" />
	<meta property="og:description" content="The Only Portfolio Website Ever" />
	<meta name="twitter:image" itemprop="image" content="/Ojasvi.jpg" />
	<meta name="twitter:card" content="summary" />
	<title>26_Ojasvi</title>
</svelte:head>
